...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", siteName: "Ikigai — The Royal Map of Purpose", title: "Ikigai — Discover Purpose, Meaning, and Direction", description: "A private, practical journey to understand energy, meaning, connection, and momentum.", images: [{ url: "/social-preview.png", width: 1280, height: 640, alt: "Ikigai — The Royal Map of Purpose: turn self-reflection into a map for meaningful living." }] },
  twitter: { card: "summary_large_image", title: "Ikigai — Discover Purpose, Meaning, and Direction", description: "Private reflection tools, purpose map, flow lab, 30-day plan, journal.", images: ["/social-preview.png"] },
